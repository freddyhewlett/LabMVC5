...
namespace MvcMovie.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        [HttpPost]        
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, string title, string director, DateTime releasedate, decimal gross, double rating, string imageUrl, int genreID, HttpPostedFileBase image)                                                                                //([Bind(Include = "ID,Title,Director,ReleaseDate,Gross,Rating,GenreID")] Movie movie)
        {
        ...
        {
            var genres = movieDb.Genres.OrderByDescending(g => g.Movies.Count).Take(num).ToList();
